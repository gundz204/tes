...
export default function ErrorModal({ message = "Error occurred!", onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Lingkaran merah dengan icon silang */}
        <div className="bg-red-500 rounded-full p-5 shadow-lg">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <p className="text-red-700 text-xl font-semibold text-center select-none">{message}</p>
      </div>
    </div>
  );
}
